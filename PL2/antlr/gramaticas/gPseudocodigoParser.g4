...
instruccion: expr dospuntos (instrucciones)* ;
deotromodo:kwdeotromodo dospuntos (instrucciones)*;
...
//Definir Funcion
deffuncion:kwfuncion id kwflecha invocafuncion instrucciones+ kwfinfuncion|
kwfuncion invocafuncion instrucciones+ kwfinfuncion;
...
//keywords funcion
kwfuncion:FUNCION;
invocafuncion:id pi (expr (coma expr)*)? pd;
